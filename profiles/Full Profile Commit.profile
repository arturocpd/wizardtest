...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>Case.mass_back_test__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
    ...
    <layoutAssignments>
        <layout>ApptBundleConfig-Formato Configuración de paquete de citas</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ApptBundlePolicy-Formato Política de paquete de citas</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>ContractLineOutcome-Formato Resultado de partida de contrato</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ContractLineOutcomeData-Formato Dato de resultado de partida de contrato</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Electronics__c-Custom Electronics</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>TravelMode-Formato Modo de desplazamiento</layout>
    </layoutAssignments>
    <layoutAssignments>
